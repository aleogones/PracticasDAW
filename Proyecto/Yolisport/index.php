                                ...
                                <li class="nav-item dropdown">
                                    <a href="#account_menu"
                                       ...
                                       data-caret="false">
                                        <span class="mr-1 d-flex-inline">
                                            <span class="text-light"><?php echo $user_name ?>.</span>
                                        </span>
                                    ...
                                    <div id="account_menu"
                                        ...
                                        <div class="dropdown-item-text dropdown-item-text--lh">
                                            <div><strong><?php echo $user_name ?></strong></div>
                                            <div class="text-muted"><?php echo $user_email ?></div>
                                        </div>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item active"
                                           href="index.php"><i class="material-icons">dvr</i> Dashboard</a>
                                        <a class="dropdown-item"
                                           href="index.php?my-account"><i class="material-icons">account_circle</i> My profile</a>
            ...
            <div class="mdk-header-layout__content">
                ...
                <div class="mdk-drawer-layout js-mdk-drawer-layout"
                     ...
                     data-responsive-width="992px">
                        ...
                        <?php
                        if (  !isset($_GET['view-exercises']) && !isset($_GET['view-exercise']) && !isset($_GET['my-account']) && !isset($_GET['add-exercises']) && !isset($_GET['delete-exercise']) && !isset($_GET['profile-update']))
                        { ?>
                                    ...
                                    <ul class="sidebar-menu"
                                        ...
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button"
                                               href="index.php?my-account">
                                               
                                                <span class="sidebar-menu-text"><i class="material-icons dp48">group</i>Profile</span>
                                            </a>
                                        </li>
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button"
                                               href="index.php?view-exercises">
                                                <span class="sidebar-menu-text"><i class="material-icons dp48">list</i>My Exercises</span>
                                            </a>
                                        </li>
