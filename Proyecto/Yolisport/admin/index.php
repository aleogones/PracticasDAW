...
<!-- Mirrored from demo.frontted.com/YOLISPORT/120/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jun 2023 13:15:14 GMT -->
<head>
        <meta charset="utf-8">
                                ...
                                <li class="nav-item dropdown">
                                    <a href="#account_menu"
                                       ...
                                       data-caret="false">
                                        <span class="mr-1 d-flex-inline">
                                            <span class="text-light"><?php echo $_SESSION['admin_name'] ?>.</span>
                                        </span>
                                        <img src="assets/images/profile-icon-9.png"
                                    ...
                                    <div id="account_menu"
                                        ...
                                        <div class="dropdown-item-text dropdown-item-text--lh">
                                            <div><strong><?php echo $_SESSION['admin_name'] ?></strong></div>
                                            <div class="text-muted"><?php echo $_SESSION['admin_email'] ?></div>
                                        </div>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item active"
                                           href="index.php"><i class="material-icons">dvr</i> Dashboard</a>
                                        <a class="dropdown-item"
                                           href="index.php?profile-update=<?php echo $_SESSION['admin_id'] ?>"><i class="material-icons">account_circle</i> My profile</a>
                                        <a class="dropdown-item"
                                           href="index.php?profile-update=<?php echo $_SESSION['admin_id'] ?>"><i class="material-icons">edit</i> Edit account</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                           href="logout.php"><i class="material-icons">exit_to_app</i> Logout</a>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="mdk-drawer-layout js-mdk-drawer-layout"
                     ...
                     data-responsive-width="992px">
                        ...
                        <?php
                            ...
                            if (isset($_GET['view-exercises'])) {
								include("view-exercises.php");
							}
                            if (isset($_GET['edit-exercises'])) {
								include("edit-exercises.php");
							}
                            if (isset($_GET['add-exercises'])) {
								include("add-exercises.php");
							}
                        ...
                        <?php
                        if (  !isset($_GET['view-users']) && !isset($_GET['view-exercises']) && !isset($_GET['edit-exercises']) && !isset($_GET['add-exercises']) && !isset($_GET['delete-exercise']) && !isset($_GET['profile-update']) && !isset($_GET['delete_user']))
                        { ?>
                                        ...
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button"
                                               href="index.php?view-users">
                                                ...
                                                <span class="sidebar-menu-text"><i class="material-icons dp48">group</i>User Lists</span>
                                            </a>
                                        </li>
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button"
                                               href="index.php?view-exercises">
                                                <span class="sidebar-menu-text"><i class="material-icons dp48">list</i>Exercise Lists</span>
                                            </a>
                                        </li>
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button"
                                               href="index.php?add-exercises">
                                                <span class="sidebar-menu-text"><i class="material-icons dp48">create</i>Add Exercises</span>
                                            </a>
                                        </li>
...
<!-- Mirrored from demo.frontted.com/YOLISPORT/120/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jun 2023 13:16:04 GMT -->
</html>